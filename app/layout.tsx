...
export const metadata: Metadata = {
  ...
  description: "منصة تفاعلية لتقدير فرص القبول في ENCG وENA وENSA وENSAM وكليات الصحة وFST وEST.",
  keywords: ["Orientation LGOSS", "orientation Maroc", "ENCG", "ENA Architecture", "ENSA", "ENSAM", "médecine Maroc", "FST", "EST", "listes d'attente 2026"],
  ...
  openGraph: {
    ...
    description: "حسب فرصتك في مدارس التجارة والهندسة المعمارية والهندسة والصحة والعلوم والتكنولوجيا.",
  ...
  twitter: {
    ...
    title: "ORIENTATION LGOSS | منصة التوجيه والقبول",
    description: "محاكيات ENCG وENA وENSA وENSAM والصحة وFST وEST في منصة واحدة.",
    images: ["/og.png"],
  },
  icons: {
    icon: "/favicon.svg",
