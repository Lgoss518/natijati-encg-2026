...
export const metadata: Metadata = {
  ...
  description: "منصة تفاعلية لتقدير فرص القبول في ENCG وكليات الصحة وFST وEST.",
  keywords: ["Orientation LGOSS", "orientation Maroc", "ENCG", "médecine Maroc", "FST", "EST", "listes d'attente 2026"],
  ...
  openGraph: {
    ...
    description: "حسب فرصتك في مدارس التجارة والصحة والعلوم والتكنولوجيا.",
  ...
  twitter: {
    ...
    title: "ORIENTATION LGOSS | منصة التوجيه والقبول",
    description: "محاكيات ENCG والصحة وFST وEST في منصة واحدة.",
    images: ["/og.png"],
  },
  icons: {
    icon: "/favicon.svg",
