...
export default function Home(){
  ...
  return <main dir={fr?"ltr":"rtl"} className={`site-shell ${fr?"is-fr":"is-ar"} ${!entered?"is-locked":""} ${network!=="encg"?"network-academic":""}`}>
    ...
    <div className="site-content" aria-hidden={!entered}>
      ...
      <section className="hero"><div className="eyebrow">{t.eyebrow}</div><h1>{t.hero1}<br/><em>{t.hero2}</em></h1><p>{t.intro}</p><div className="trust"><span>4</span> {t.schoolsCount} <b>•</b> <span>+35 000</span> {t.lines} <b>•</b> {t.private}</div></section>
